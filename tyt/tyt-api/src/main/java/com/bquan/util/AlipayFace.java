...
public class AlipayFace {
    private static Log                  log = LogFactory.getLog(AlipayFace.class);
    ...
    public AlipayFace(String pid,String appid,String privateKey,String publicKey,String alipayPublicKey,String signType)
    {
  ...
  /*  static {
    ...
    public static void main(String[] args) {
       // AlipayFace main = new AlipayFace();
    ...
    // 测试当面付2.0生成支付二维码
    public JSONObject test_trade_precreate(String money,String orderid,String notifyurl,String appauthtoken) {
        // (必填) 商户网站订单系统中唯一订单号，64个字符以内，只能包含字母、数字、下划线，
        // 需保证商户系统端不能重复，建议通过数据库sequence生成，
      ...
      //  List<GoodsDetail> goodsDetailList = new ArrayList<GoodsDetail>();
       ...
       // goodsDetailList.add(goods2);
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
            ...
            .setAppAuthToken(appauthtoken);
           // .setAppAuthToken("201705BBa5a7b06d0e9e4af28493316a76000X16");
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                test.put("msg", response.getQrCode());
