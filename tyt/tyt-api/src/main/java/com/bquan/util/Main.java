...
public class Main {
    ...
    // 测试当面付2.0生成支付二维码
    public JSONObject test_trade_precreate(String money) {
        // (必填) 商户网站订单系统中唯一订单号，64个字符以内，只能包含字母、数字、下划线，
        // 需保证商户系统端不能重复，建议通过数据库sequence生成，
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
            ...
            .setNotifyUrl("http://b5edy7.natappfree.cc/bquan/wap/qrcode!payback.action")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
