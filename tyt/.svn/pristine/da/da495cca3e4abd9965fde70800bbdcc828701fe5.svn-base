...
import com.bquan.dao.read.SysMenuReadDao;
...
public class SysMenuReadServiceImpl implements SysMenuReadService {
	@Autowired
	private SysMenuReadDao sysMenuDao;
	@Autowired
	private SysUserReadService sysUserService;
	@Autowired
	private SysRoleMenuReadService sysRoleMenuService;
