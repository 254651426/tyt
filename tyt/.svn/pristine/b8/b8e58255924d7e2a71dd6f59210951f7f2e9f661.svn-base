...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        //获取spring bean
        ScheduleJobLogReadService scheduleJobLogService = (ScheduleJobLogReadService) SpringContextUtils.getBean("scheduleJobLogService");
        ...
        try {
			...
			//scheduleJobLogWriteService.save(log);
		}
    }
}
