...
import com.bquan.util.HttpContextUtils;
import com.bquan.util.IPUtils;
...
public class SysLogAspect {
	...
	@Pointcut("@annotation(com.bquan.annotation.SysLog)") 
	...
	public void saveSysLog(JoinPoint joinPoint) {
		...
		//保存系统日志
		sysLogWriteService.save(sysLog);
	}
